...
# **AURA_REG_COLORS** 0x8000
Block transfer 15 bytes of color data to this address for direct color control.  Format is RBGRBGRBGRBGRBG.  Each Aura controller supports up to 5 outputs.
