...
OpenRGB provides an E1.31 controller to drive these devices.  Since E1.31 does not provide an autodetection mechanism, E1.31 devices must be configured in a configuration file called e131.txt, placed in the same directory as the OpenRGB executable file.  Multiple device entries are allowed, though you should make sure the universe/channel configuration of the devices do not overlap.
