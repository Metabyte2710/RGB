...
On motherboards, the SMBus master is usually part of the chipset.  Windows does not provide user-accessible drivers for transferring data on the SMBus interfaces, but Linux does.  The [i2c-tools package](https://i2c.wiki.kernel.org/index.php/I2C_Tools) provides user-accessible set, get, and detect functions to talk to I<sup>2</sup>C/SMBus devices on your PC's motherboard.  This was very beneficial in early Aura reverse engineering efforts.
